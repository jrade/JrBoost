...
void BaseOptions::setMaxTreeDepth(size_t d)
{
    maxTreeDepth_ = d;
}
...
void BaseOptions::setStratifiedSamples(bool b)
{
    stratifiedSamples_ = b;
}
...
void BaseOptions::setSelectVariablesByLevel(bool b)
{
...
void BaseOptions::setSaveMemory(bool b)
{
    saveMemory_ = b;
}

void BaseOptions::setTest(size_t n)
{
    test_ = n;
}
